...
maintained on @link["http://github.com/"]{Github} at the following
URL:
...
as described in @emph{@link["http://htdp.org/"]{How to Design
...
The objective of the design recipe is to provide a @emph{technique}
...
their skills with each day of programming.  As the chef Jacques Pépin
said, @note{@emph{New York Times},
``@link["http://www.ccs.neu.edu/home/dvanhorn/tmp/programming-is-like-cooking.pdf"]{There's
the Wrong Way and Jacques Pépin's Way}'' October 18, 2011.} speaking of
another field that values the idea of recipes, to master the
...
--- Edsger W. Dijkstra ``@link["http://www.cs.utexas.edu/users/EWD/transcriptions/EWD03xx/EWD340.html"]{The
Humble Programmer}'', Turing Award Lecture, 1972}
...
In the second part, we transition to Java, a widely used industrial
language that has been developed over more than 15 years.  The move to
Java allows us to explore the application of the principles introduced
in the first portion of the course in the context of a practical
language.

As of this draft of the book, the course software has been developed
and tested with version 5.2 of
@link["http://racket-lang.org/"]{Racket}.  To install the course
software, you will first need to install Racket:

@centered{@url{http://racket-lang.org/}}

Once installed, launch DrRacket, the development environment that
ships with the Racket system.  Click on the @menuitem["File" "Install
PLT File"], and then enter the URL:
